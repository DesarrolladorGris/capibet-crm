            ...
            getFilteredConversations().map((conversation) => (
              ...
              >
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-[var(--bg-tertiary)] flex-shrink-0 flex items-center justify-center">
                    <span className="text-sm font-semibold">
                      {conversation.cliente_nombre?.charAt(0).toUpperCase() || 'C'}
                    </span>
                  </div>
            ...
            <div className="p-4 border-b border-[var(--border-primary)] flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-full bg-[var(--bg-tertiary)] flex items-center justify-center">
                  <span className="text-sm font-semibold">
                    {selectedConversation.cliente_nombre?.charAt(0).toUpperCase() || 'C'}
                  </span>
                </div>
                <div>
