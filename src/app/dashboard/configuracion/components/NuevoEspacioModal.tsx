...
import { espacioTrabajoService, EspacioTrabajoData } from '@/services/espacioTrabajoServices';
...
export default function NuevoEspacioModal({ isOpen, onClose, onEspacioCreated }: NuevoEspacioModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Llamar al servicio
      const result = await espacioTrabajoService.createEspacioTrabajo(espacioData);
